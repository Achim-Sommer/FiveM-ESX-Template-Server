...
(2, 'police', 0, 'recruit', 'Anwärter', 20, '{}', '{}'),
(3, 'police', 1, 'officer', 'Polizist', 40, '{}', '{}'),
(4, 'police', 2, 'sergeant', 'Unteroffizier', 60, '{}', '{}'),
(5, 'police', 3, 'lieutenant', 'Leutnant', 85, '{}', '{}'),
(6, 'police', 4, 'boss', 'Polizeichef', 100, '{}', '{}'),
...
INSERT INTO `fine_types` (label, amount, category) VALUES
	...
	('Geschwindigkeitsüberschreitung über > 30 km/h', 300, 0),
	('Beeinträchtigung des Verkehrsflusses', 110, 1),
	('Öffentliche Trunkenheit', 90, 1),
	('Ordnungswidriges Verhalten', 90, 1),
	('Behinderung der Justiz', 130, 1),
	('Beleidigungen gegenüber Zivilisten', 75, 1),
	('Respektlosigkeit gegenüber einem Polizisten', 110, 1),
	('Verbale Drohung gegenüber einem Zivilisten', 90, 1),
	('Verbale Drohung gegenüber einem Polizisten', 150, 1),
	('Falsche Informationen geben', 250, 1),
	('Versuch der Korruption', 1500, 1),
	('Tragen einer Waffe innerhalb der Stadtgrenzen', 120, 2),
	('Eine tödliche Waffe im Stadtgebiet einsetzen', 300, 2),
	('Kein Waffenschein', 600, 2),
	('Besitz einer illegalen Waffe', 700, 2),
	('Besitz von Einbruchswerkzeug', 300, 2),
	('Autodiebstahl', 1800, 2),
	('Absicht zum Verkauf/Vertrieb einer illegalen Substanz', 1500, 2),
	('Besitz einer illegalen Substanz', 1500, 2),
	('Besitz einer illegalen Substanz ', 650, 2),
	('Entführung eines Zivilisten', 1500, 2),
	('Entführung eines Polizisten', 2000, 2),
	('Raubüberfall', 650, 2),
