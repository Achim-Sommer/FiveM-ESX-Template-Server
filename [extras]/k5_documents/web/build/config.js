...
const TEXTS = {
  ...
  issuedDocumentsTitle: 'Ausgestellte Dokumente',
  ...
  deleteTemplateTitle: 'Template löschen',
  deleteTemplateQuestion: 'Bist dfu sicher, dass du dieses Template löschen willst?:',
  date: 'Datum',
  newDocumentBtn: 'Neues Dokument',
  newCitizenDocumentBtn: 'Neues Bürgerdokument',
  deleteDocumentTitle: 'Dokument löschen',
  deleteDocumentQuestion: 'bist du sicher, dass du dieses Dokument löschen willst?:',
  signHereText: 'Hier unterschreiben',
  selectDocumentType: 'Wähl ein Dokumenttyp aus',
  cannotIssueDocument: 'Du kannst mit deinem job keine Dokumente austellen',
