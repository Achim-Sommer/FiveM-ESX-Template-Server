...
print("^0======================================================================^7")
print("^0[^4Author^0] ^7:^0 ^Achim#7834^7")
print("^0[^3Version^0] ^7:^0 ^v1.0.0^7")
print("^0[^1YouTube^0] ^7:^0 ^5https://youtube.com/GermanGaming^7")
print("^0[^Forum^0] ^7:^0 ^5https://forum.achimsommer.com^7")
print("^0======================================================================^7")
print("^0[^2Shop^0] ^7:^0 ^5https://shop.achimsommer.com^7")
print("^0[^2PayPal^0] ^7:^0 ^5sommerachim@hotmail.de^7")
print("^0======================================================================^7")
print("^0=Viel Spaß!^7")
print("^0======================================================================^7")
print("^0Den BASE Server kann man kostenlos laden!^7")
print("^0[^2Download^0] ^7:^0 ^5https://github.com/Achim-Sommer/FiveM-ESX-Template-Server^7")
print("^0======================================================================^7")
